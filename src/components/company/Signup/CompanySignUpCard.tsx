...
import OtpPage from "./../../user/SignUp/OtpPage";
...
const CompanySignUpCard : React.FC = () => {
      ...
      {stepFirst ? (
        ...
        <div className=" bg-white w-4/5 rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            <h6 className="text-xl text-center font-bold leading-tight tracking-tight text-gray-900 md:text-xl dark:text-white">
              Create an for your company account
            </h6>
